        ...
        while True:
            ...
            # Withdraw
                ...
                if amt < accountobj.getBalance():
                    ...
                    print("\nYour balance is less than withdrawl amount: " + str(accountobj.getBalance()) + "$")
...
def main():
    ...
    while running:
        ...
        # To use ATM at the entrance
        if command == "ATM" and (row, col) == (0, 2):
            bank(accounts)

        # To play blackjack from the blackjack room
        ...
        # To cash in chips from the blackjack room
        ...
        elif command == "go cafeteria" and (row, col) == (0, 1):
            buy(accounts)
